      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">AI Recommendations</span></li>
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Swipe Networking</span></li>
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Real-time Chat</span></li>
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Team Formation</span></li>
            </ul>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Legal</h4>
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Privacy Policy</span></li>
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Terms of Service</span></li>
              <li><span className="hover:text-neon-cyan transition-colors cursor-pointer">Code of Conduct</span></li>
            </ul>
          </div>
        </div>
        <div className="mt-8 border-t border-white/5 pt-8 text-center text-xs">
          <p>&copy; {new Date().getFullYear()} LinkUp AI. Powered by Cosine Similarity & WebSockets.</p>
        </div>
      </div>
    </footer>
  );
